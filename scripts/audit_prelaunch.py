...
check('secure your presale position before public launch' in index_lower, 'professional presale launch wording missing')
check('expected rlya allocation' in index_lower, 'buyer expected-allocation wording missing')
check('actual rlya tokens are distributed to that same wallet 1 day before public launch' in index_lower, 'buyer one-day prelaunch distribution wording missing')
