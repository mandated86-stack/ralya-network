...
for f in "${BUNDLED[@]}" web/owner/status-control.js web/owner/presale-control.js web/owner/site-copy-control.js web/owner/launch-countdown-control.js web/launch-status.js web/launch-countdown.js web/site-content.js web/site-config.js web/site-ui.js web/site-ui-hotfix.js web/wallet-mobile-fix.js web/live-presale-ui.js scripts/browser-buffer-shim.js; do node --check "$f"; done
