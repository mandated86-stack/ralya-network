...
./node_modules/.bin/esbuild "$TMP/web/app.js" \
  --bundle --format=esm --platform=browser --target=es2022 --minify \
  --outfile="$TMP/app.bundle.js"

./node_modules/.bin/esbuild "$TMP/web/admin/admin.js" \
  --bundle --format=esm --platform=browser --target=es2022 --minify \
  --outfile="$TMP/admin.bundle.js"

./node_modules/.bin/esbuild "$TMP/web/owner/launch.js" \
