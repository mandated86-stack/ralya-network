...
check('activate + immediately pause' in owner_html, 'owner launch does not expose staged activate/pause checkpoint')
...
print('website contains real wallet/balance/purchase/referral paths, enforced presale gate, owner launch and smoke tools')
