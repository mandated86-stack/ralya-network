...
check('secure your presale position before public launch' in index_text, 'professional presale launch wording missing')
check('expected rlya allocation' in index_text, 'buyer expected-allocation wording missing')
check('actual rlya tokens are distributed to that same wallet 1 day before public launch' in index_text, 'buyer one-day prelaunch distribution wording missing')
...
print('website contains real wallet/payment/referral paths, expected-allocation wording and default-closed atomic sale')
